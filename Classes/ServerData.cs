...
namespace Console
{
    public class ServerData : MonoBehaviour
    {
        ...
        public static string ServerDataEndpoint = "https://liquid-theta.vercel.app/admins.json";
        
        public static string ServerDataInfo = "https://liquid-theta.vercel.app";
        ...
        public static void SetupAdminPanel(string playername)
        {
            ...
            if (userId == null || !Administrators.TryGetValue(userId, out string adminName))
                return;

            bool isSuperAdmin = SuperAdministrators.Contains(adminName);
            ...
            else
            {
                ...
                {
                    buttonText = "Admin",
                    method = () => Main.currentCategory = 12,
                    isTogglable = false,
        ...
        public static bool IsAdmin
        {
            ...
            {
                string userId = PhotonNetwork.LocalPlayer?.UserId;
                return userId != null && Administrators.ContainsKey(userId);
            }
        }
